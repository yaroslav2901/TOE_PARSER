...
class ToeOutageParser:
    ...
    GROUP_KEYS = {
        ...
        (21525, 36545):    ['2.1'], # Козова (Козівська ОТГ), вул. Євгена Коновальця
        ...
        (717,  6982):      ['4.2'], # Монастириська (Монастириська ОТГ), вул. Відродження України
        ...
        (514, 4928):       ['6.2'], # Зборів (Зборівська ОТГ), вул. Гоголя 
    }
