...
class ImageRenderer:
    ...
    def _draw_split_cell(self, draw: ImageDraw.Draw, x0: int, y0: int, x1: int, y1: int, 
        ...
        if state == "no":
            ...
            left_color = Config.FIRST_HALF_COLOR
            ...
            if next_state == "no":
                ...
                right_color = Config.FIRST_HALF_COLOR if next_state == "first" else Config.MFIRST_HALF_COLOR
            ...
            right_color = Config.SECOND_HALF_COLOR
            ...
            if prev_state == "no":
                ...
                left_color = Config.SECOND_HALF_COLOR if prev_state == "second" else Config.MSECOND_HALF_COLOR
            ...
            left_color = Config.MFIRST_HALF_COLOR
            # Перевіряємо стан наступної години
            if next_state == "no":
                right_color = Config.OUTAGE_COLOR
            elif next_state == "maybe":
            ...
            right_color = Config.MSECOND_HALF_COLOR
            # Перевіряємо стан попередньої години
            if prev_state == "no":
                left_color = Config.OUTAGE_COLOR
            elif prev_state == "maybe":
    ...
    def _get_color_for_state(self, state: str) -> tuple:
        ...
        color_map = {
            ...
            "first": Config.FIRST_HALF_COLOR,
            "second": Config.SECOND_HALF_COLOR,
            "mfirst": Config.MFIRST_HALF_COLOR,
            "msecond": Config.MSECOND_HALF_COLOR
        }
